...
import 'package:face_net_authentication/pages/widgets/signin_form2.dart';
...
class SecurityState extends State<Security> {
  ...
  Widget build(BuildContext context) {
    Widget header = CameraHeader("SECURITY", onBackPressed: _onBackPressed);
