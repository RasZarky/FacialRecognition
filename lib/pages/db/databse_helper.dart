...
class DatabaseHelper {
  ...
  static final columnProgramme = 'programme';
  static final columnIndexNumber = 'index_number';
  static final columnLevel = 'level';
  static final columnRegistration = 'registration';
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute('''
          CREATE TABLE $table (
            ...
            $columnProgramme TEXT NOT NULL,
            $columnIndexNumber TEXT NOT NULL,
            $columnLevel TEXT NOT NULL,
            $columnRegistration TEXT NOT NULL,
